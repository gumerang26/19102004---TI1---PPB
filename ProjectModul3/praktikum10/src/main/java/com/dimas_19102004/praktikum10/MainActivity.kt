...
import com.dimas_19102004.praktikum10.adapter.QuoteAdapter
import com.dimas_19102004.praktikum10.data.Quote
import com.dimas_19102004.praktikum10.databinding.ActivityMainBinding
...
import com.dimas_19102004.praktikum10.helper.REQUEST_ADD
import com.dimas_19102004.praktikum10.helper.REQUEST_UPDATE
...
import com.dimas_19102004.praktikum10.helper.mapCursorToArrayList
        ...
        if (data != null) {
            when (requestCode) {
                ...
                REQUEST_UPDATE -> when (resultCode) {
                    RESULT_UPDATE -> { val quote = data.getParcelableExtra<Quote>(EXTRA_QUOTE) as Quote
